...
<form action="https://www.moneybookers.com/app/payment.pl" method="POST" id="payment_form">
    ...
    <input name="return_url_text" value="Return {{$general->title}}" type="hidden">
    ...
    <input name="detail1_description" value="{{$general->title}}" type="hidden">

    <input name="detail1_text" value="Deposit To {{$general->title}}" type="hidden">
