...
@section('page_name', 'Ödeme Yöntemi Listesi')
@section('body')
    <div class="row">
        @include('admin.layouts.flash')
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title">Ödeme Yöntemleri</h3>
                <table class="table table-hover">
                    ...
                    @foreach($items as $item)
                        <tr>
                            ...
                            <td>
                                @if($item->status == 0)
                                    <b style="color: #b2344c">Kapalı</b>
                                    @elseif($item->status == 1)
                                <b style="color: #2ab27b">Açık</b>
                                    @endif
                            </td>
                            <td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4><b>Ödeme Yöntemi Düzenle</b></h4>
                </div>
