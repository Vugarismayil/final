...
@section('page_name', 'Logo-Icon Ayarları')
@section('body')
    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="d-flex justify-content-center" style="width: 150px; height: 80px; border: 1px solid #000000">
                                    <img src="{{ asset('assets/frontend/upload/logo/logo.png') }}" id="logo-img" style="max-width: 125px; max-height: 60px;">
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="d-flex justify-content-center" style="width: 150px; height: 80px; border: 1px solid #000000">
                                    <img src="{{ asset('assets/frontend/upload/logo/icon.png') }}" id="icon-img" style="max-width: 125px; max-height: 60px;">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="d-flex justify-content-center" style="width: 150px; height: 80px; border: 1px solid #000000">
                                    <img src="{{ asset('assets/frontend/upload/logo/bread.png') }}" id="bread-img" style="max-width: 125px; max-height: 60px;">
                                </div>
                                <div class="form-group">
                                    <label class="control-label"><b>Header Kısmı</b></label>
                                    <input class="form-control form-control-lg" type="file" name="bread_crumb" id="bread_crumb">
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on('change', '#bread_crumb', function () {
                breadURL(this);
            });

            function breadURL(input) {

                if (input.files && input.files[0]) {
                    var reader = new FileReader();
                    reader.onload = function (e) {
                        $('#bread-img').attr('src', e.target.result);
                    }
                    reader.readAsDataURL(input.files[0]);
                }
            }
