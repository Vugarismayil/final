...
@section('page_icon', 'fa fa-bullhorn')
@section('page_name', 'Duyuru Ayarları')
@section('addButton')
    <a class="btn btn-outline-success btn-lg" href="#" data-toggle="modal" data-target="#addIcon"><i
                class="fa fa-plus-circle"></i> Duyuru Ekle</a>
@endsection
@section('body')
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title">Duyuru Listesi</h3>
                <div class="row">
                            ...
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    <img class="w-100 mb-2"
                                         src="{{ asset('assets/frontend/upload/announcement') }}/{{ $item->image }}">
                                    ...
                                    <div class="text-center">
                                        <button class="btn btn-outline-info item_edit_btn" data-toggle="modal"
                                                data-target="#editSocial" data-route="{{ route('admin.announcements.update', $item->id) }}" data-title="{{ $item->title }}"
                                        ...
                                        <button class="btn btn-outline-danger item_delete_btn" data-toggle="modal"
                                                data-target="#deleteitem" data-route="{{ route('admin.announcements.delete', $item->id) }}"><i class="fa fa-trash"></i> Sil
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="portlet-body form">
                            <form role="form" action="{{route('admin.announcements.store')}}" method="post"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group nic-group">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <form action="" method="post" id="delete-form">
                        @csrf
                        @method('delete')
                        <h3 class="d-flex justify-content-center">Duyuruyu silmek istiyor musunuz?</h3>
