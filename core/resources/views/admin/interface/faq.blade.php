...
@section('page_icon', 'fa fa-question')
@section('page_name', 'S.S.S Ayarları')
@section('addButton')
    <a class="btn btn-outline-success btn-lg" href="#" data-toggle="modal" data-target="#addIcon"><i
                class="fa fa-plus-circle"></i> S.S.S Ekle</a>
@endsection
@section('body')
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title">S.S.S Listesi</h3>
                <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <button class="btn btn-outline-info item_edit_btn" data-toggle="modal"
                                                data-target="#editSocial" data-route="{{ route('admin.faq.update', $item->id) }}" data-title="{{ $item->title }}"
                                        ...
                                        <button class="btn btn-outline-danger item_delete_btn" data-toggle="modal"
                                                data-target="#deleteitem" data-route="{{ route('admin.faq.delete', $item->id) }}"><i class="fa fa-trash"></i> Sil
                                        </button>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <form action="" method="post" id="delete-form">
                        @csrf
                        @method('delete')
                        <h3 class="d-flex justify-content-center">S.S.S silmek istiyor musunuz?</h3>
